...
# Time : 21:14
# Author : Pin-Hao , Chen 
# Pupose : Kaggle RSNA Pneumonia detection challenge 
# WARNING ! I don't own this code , these code are copied from 
...
folder = './input/stage_2_train_images'
train_gen = generator(folder, train_filenames, pneumonia_locations, batch_size=1, image_size=256, shuffle=True, augment=True, predict=False)
valid_gen = generator(folder, valid_filenames, pneumonia_locations, batch_size=1, image_size=256, shuffle=False, predict=False)

history = model.fit_generator(train_gen, validation_data=valid_gen, callbacks=[learning_rate], epochs=25, workers=1, use_multiprocessing=False)
